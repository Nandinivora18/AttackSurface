"""
OWASP A06:2025 — Insecure Design Assessment Module
==================================================
...
honestly reports NOT_VERIFIABLE rather than an unfounded PASS.
"""
...
async def assess_a06_insecure_design(
    design_questionnaire: dict[str, Any] | None = None,
    openapi_spec: dict[str, Any] | None = None,
) -> dict[str, Any]:
    """
    Executes A06:2025 Insecure Design assessment based on supplied design evidence.
    """
    ...
    if design_questionnaire and isinstance(design_questionnaire, dict):
        ...
        if not design_questionnaire.get("threat_modeling_conducted", False):
            findings.append({
                ...
                "references": ["https://owasp.org/Top10/A06_2025-Insecure_Design/"],
    ...
    if not has_evidence:
        ...
        confidence = "LOW"
        limitations = (
            "A06 Insecure Design cannot be proven solely from external HTTP observation. "
...
assess_a04_insecure_design = assess_a06_insecure_design
